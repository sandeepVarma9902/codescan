export function createPlan(scan, target = 'vite') {
  if (target === 'react-native') {
    ...
    return {
      ...
      reason: analysis?.approvalRequired ? 'Eligible for an Expo Router conversion using generated, reviewable native recipe decisions.' : 'Eligible for direct Expo Router conversion.',
